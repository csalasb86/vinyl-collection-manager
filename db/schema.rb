...
ActiveRecord::Schema[8.0].define(version: 2026_08_28_152131) do
  ...
  create_table "albums", force: :cascade do |t|
    ...
    t.index ["format"], name: "index_albums_on_format"
    t.index ["genre"], name: "index_albums_on_genre", using: :gin
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "discogs_authenticated_at"
    t.datetime "discogs_synced_at"
    t.string "locale"
    t.datetime "discogs_sync_started_at"
    t.index ["discogs_username"], name: "index_users_on_discogs_username"
